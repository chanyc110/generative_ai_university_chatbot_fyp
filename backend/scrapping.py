...
# persistent_directory = os.path.join(db_dir, "chroma_db_website")


# # Step 1: Scrape the content from apple.com using WebBaseLoader
# # WebBaseLoader loads web pages and extracts their content
# urls = ['https://www.nottingham.edu.my/ugstudy/course/foundation-in-engineering']
...
# def search_similar_vectors_meow(user_query):
